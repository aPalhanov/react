...
export default class DisplayMap extends Component {
    ...
    ensureMapExists() {
        if (this.state.mapLoaded) return;
				...
				/*
				this.L.mapbox.accessToken = 'pk.eyJ1IjoicGFsaGFub3YiLCJhIjoiY2tveTBlNDJ0MDR5dTJ4cTdoYWx3YjM3NSJ9.nqxVikVy2PZ8CcmcIRcdkw';			
				
				this.map = this.L.mapbox.map(this.mapNode, 'mapbox.satellite', {
					zoomControl: true,
				...
				*/   
				...
				this.map = this.L.mapbox.map(this.mapNode).setView([this.state.location.lat, this.state.location.lng], 9).addLayer(this.L.mapbox.styleLayer('mapbox://styles/mapbox/streets-v11'));
    ...
    updateMapPosition(location) {
        ...
        this.map.setView(this.L.latLng(lat, lng),9);
    ...
    generateStaticMapImage(lat, lng) {
        return `https://api.mapbox.com/styles/v1/mapbox/streets-v10/static/${lat},${lng},12,0,0/600x175?access_token=pk.eyJ1IjoicGFsaGFub3YiLCJhIjoiY2tveTBlNDJ0MDR5dTJ4cTdoYWx3YjM3NSJ9.nqxVikVy2PZ8CcmcIRcdkw`;
    }
    render() {
        return [
